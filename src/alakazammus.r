...
#####
subtypemeans_and_sds0 <- subset(submeans_and_sds, GANDA_SUBTYPE %in% c("IGHA1", "IGHA4", "IGHA6", "IGHG1", "IGHG2a", "IGHG2b", "IGHG2c", "IGHG3"))
...
#subtypemeans_and_sds0 <- replace_na(subtypemeans_and_sds1, list(n1 = 0))

#df <- tibble(x = c(1, 2, NA), y = c("a", NA, "b"), z = list(1:5, NULL, 10:20))
#df %>% replace_na(list(n1 = 0))
#subtypemeans_and_sds0$n1 %>% replace_na(0)
subtypemeans_and_sds0 <- replace_na(subtypemeans_and_sds0, list(n1 = 0))
subtypemeans_and_sds0 <- replace_na(subtypemeans_and_sds0, list(n1b = 0))
subtypemeans_and_sds0 <- replace_na(subtypemeans_and_sds0, list(n2 = 0))
subtypemeans_and_sds0 <- replace_na(subtypemeans_and_sds0, list(n2b = 0))
subtypemeans_and_sds0 <- replace_na(subtypemeans_and_sds0, list(n3 = 0))
subtypemeans_and_sds0 <- replace_na(subtypemeans_and_sds0, list(n3b = 0))
subtypemeans_and_sds0 <- replace_na(subtypemeans_and_sds0, list(mutation_mean_reads = 0))
subtypemeans_and_sds0 <- replace_na(subtypemeans_and_sds0, list(mutation_sd_reads = 0))
subtypemeans_and_sds0 <- replace_na(subtypemeans_and_sds0, list(mutation_mean_clones = 0))
subtypemeans_and_sds0 <- replace_na(subtypemeans_and_sds0, list(mutation_sd_clones = 0))
subtypemeans_and_sds0 <- replace_na(subtypemeans_and_sds0, list(mutation_mean_filteredclones = 0))
subtypemeans_and_sds0 <- replace_na(subtypemeans_and_sds0, list(mutation_sd_filteredclones = 0))
...
target2 <- tibble(GANDA_SUBTYPE = c("IgG1", "IgG2a", "IgG2b", "IgG2c", "IgG3", "IgA1", "IgA4", "IgA6"))
subtypemeans_and_sds1 <- full_join(data.frame(GANDA_SUBTYPE=target2),subtypemeans_and_sds0,by="GANDA_SUBTYPE")
...
target <- tibble(GANDA_SUBTYPE = c("IgM", "IgG1", "IgG2a", "IgG2b", "IgG2c", "IgG3", "IgA1", "IgA4", "IgA6", "Kappa", "Lambda"))
isosubmeans_and_sds <- full_join(data.frame(GANDA_SUBTYPE=target),isosubmeans_and_sds0,by="GANDA_SUBTYPE")
...
hcisosubmeans_and_sds0 <- subset(isosubmeans_and_sds0, GANDA_SUBTYPE %in% c("IgA1", "IgA4", "IgA6", "IgG1", "IgG2a", "IgG2b", "IgG2c", "IgG3", "IgM"))
...
### this re-orders the rows...
htarget <- tibble(GANDA_SUBTYPE = c("IgM", "IgG1", "IgG2a", "IgG2b", "IgG2c", "IgG3", "IgA1", "IgA4", "IgA6"))
hcisosubmeans_and_sds <- full_join(data.frame(GANDA_SUBTYPE=htarget),hcisosubmeans_and_sds0,by="GANDA_SUBTYPE")
...
#isosubmeans_and_sds0$GANDA_SUBTYPE <- factor(isosubmeans_and_sds0$GANDA_SUBTYPE, levels = c("IgM", "IgG1", "IgG2", "IgG3", "IgG4", "IgA1", "IgA2", "Kappa", "Lambda"))
isosubmeans_and_sds$GANDA_SUBTYPE <- factor(isosubmeans_and_sds$GANDA_SUBTYPE, levels = c("IgM", "IgG1", "IgG2a", "IgG2b", "IgG2c", "IgG3", "IgA1", "IgA4", "IgA6", "Kappa", "Lambda"))
subtypemeans_and_sds1$GANDA_SUBTYPE <- factor(subtypemeans_and_sds1$GANDA_SUBTYPE, levels = c("IgG1", "IgG2a", "IgG2b", "IgG2c", "IgG3", "IgA1", "IgA4", "IgA6"))
hcisosubmeans_and_sds0$GANDA_SUBTYPE <- factor(hcisosubmeans_and_sds0$GANDA_SUBTYPE, levels = c("IgM", "IgG1", "IgG2a", "IgG2b", "IgG2c", "IgG3", "IgA1", "IgA4", "IgA6"))
hcisosubmeans_and_sds$GANDA_SUBTYPE <- factor(hcisosubmeans_and_sds$GANDA_SUBTYPE, levels = c("IgM", "IgG1", "IgG2a", "IgG2b", "IgG2c", "IgG3", "IgA1", "IgA4", "IgA6"))
